...
PAGES = [
    ...
    ("all-depts-strip",                   "vis/all-depts-strip.html"),
    ("all-depts-bubble",                  "vis/all-depts-bubble.html"),
    ...
    ("boulder-dept",                       "vis/boulder-dept.html"),
    ("boulder-faculty-dept",              "vis/boulder-faculty-dept.html"),
    ("boulder-dept-bubble",               "vis/boulder-dept-bubble.html"),
    ("campus-anschutz",                      "vis/campus-anschutz.html"),
    ("campus-anschutz-bubble",               "vis/campus-anschutz-bubble.html"),
    ("anschutz-dept",                        "vis/anschutz-dept.html"),
    ("anschutz-faculty-dept",               "vis/anschutz-faculty-dept.html"),
    ("anschutz-dept-bubble",                 "vis/anschutz-dept-bubble.html"),
    ("anschutz-scatter",                     "vis/anschutz-scatter.html"),
    ("campus-denver",                        "vis/campus-denver.html"),
    ("campus-denver-bubble",                 "vis/campus-denver-bubble.html"),
    ("denver-dept",                          "vis/denver-dept.html"),
    ("denver-faculty-dept",                 "vis/denver-faculty-dept.html"),
    ("denver-dept-bubble",                   "vis/denver-dept-bubble.html"),
    ("denver-scatter",                       "vis/denver-scatter.html"),
    ...
    ("colorado-springs-dept",               "vis/colorado-springs-dept.html"),
    ("colorado-springs-faculty-dept",       "vis/colorado-springs-faculty-dept.html"),
    ("colorado-springs-dept-bubble",        "vis/colorado-springs-dept-bubble.html"),
    ("colorado-springs-scatter",            "vis/colorado-springs-scatter.html"),
    ...
    ("system-administration-dept",           "vis/system-administration-dept.html"),
    ("system-administration-dept-bubble",    "vis/system-administration-dept-bubble.html"),
    ("system-administration-scatter",        "vis/system-administration-scatter.html"),
]
